...
export default function Signup() {
  ...
  const [account, setAccount] = useState(""); // simple account type state
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      ...
      // redirect to login if needed: window.location = "/login";
    }, 1200);
  };
  ...
  return (
    <div className="min-h-screen w-full bg-[#edf3fb] flex items-center justify-center px-4 py-6">
      <div className="w-full max-w-6xl min-h[540px] rounded-[28px] border border-[#c2d6eb] bg-white shadow-[0_18px_60px_rgba(15,23,42,0.18)] overflow-hidden grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="relative flex-1">
            <div className="relative h-full flex flex-col">
              ...
              <div className="flex-1 flex flex-col">
                <form onSubmit={handleSubmit} className="w-full max-w-[420px] mx-auto space-y-4">
                  {/* Email */}
                  <div>
                  ...
                  {/* Password */}
                  <div>
                    <label className="block text-[12px] font-semibold text-[#4c5a6b] mb-2">Create Password*</label>
                    <div className="flex items-center gap-3 rounded-md border border-[#d7e3ee] bg-[#fbfdff] px-3 py-2">
                  ...
                  {/* Confirm Password */}
                  <div>
                    <label className="block text-[12px] font-semibold text-[#4c5a6b] mb-2">Re-Enter Password*</label>
                    <div className="flex items-center gap-3 rounded-md border border-[#d7e3ee] bg-[#fbfdff] px-3 py-2">
                      <Lock className="w-4 h-4 text-[#9fb5c7]" />
                      <input
                  ...
                  {/* Account Type */}
                  <div>
                    <label className="block text-[12px] font-semibold text-[#4c5a6b] mb-2">Account Type</label>
                    <select
                      value={account}
                  ...
                  <div className="w-full max-w-[420px] mx-auto mt-auto pt-4 border-t border-[#dde6f0] flex items-center justify-between text-[11px] text-[#a8b9c8]">
                    ...
                    <div className="flex items-center gap-2.5">
                      <button className="hover:text-[#3d8bb5]">Terms &amp; Conditions</button>
        ...
        {/* RIGHT: IMAGE PANEL copied from Login */}
