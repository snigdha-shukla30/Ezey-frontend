...
const Dashboard = () => {
  ...
  useEffect(() => {
    async function fetchDashboard() {
      try {
        const res = await fetch("https://ezzey-backend-1-lsx0.onrender.com/dashboard/summary"); // GET /api/dashboard/summary
  ...
  if (loading || !dashboardData) {
    return (
      <div className="min-h-screen bg-[#E7EEF4] flex items-center justify-center">
        <div className="text-[#265768] text-sm">Loading dashboard...</div>
      </div>
    );
  }
        ...
        <div className="w-full max-w-[1170px] space-y-2">
          ...
          <div className="w-full bg-white rounded-[10px] border border-[#BFBFBF] shadow-[0_16px_40px_rgba(148,163,184,0.22)] px-8 pt-6 pb-6">
            ...
            <section className="flex items-start justify-end gap-6 mb-10">
              ...
              <FacultyStatus facultyList={dashboardData.facultyList} />
            </section>
...
//     fetch("https://ezzey-backend-1-lsx0.onrender.com/dashboard/summary", {
//       method: "GET",
//       headers: {
...
//   if (loading) {
//     return (
//       <div className="min-h-screen flex justify-center items-center text-lg font-medium text-gray-700">
//         Fetching Dashboard...
//       </div>
//     );
//   }
...
//     {
//       label: "Faculty",
//       count: dashboardData?.totalFaculties || 0,
//       imageUrl:
//         "https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&w=800&q=80",
//     },
//     {
//       label: "Time Tables",
//       count: dashboardData?.totalApprovedTimetables || 0,
//       imageUrl:
//         "https://images.unsplash.com/photo-1523580846011-d3a5bc25702b?auto=format&fit=crop&w=800&q=80",
//     },
//   ];
...
//               <QuickReport quickData={dashboardData?.quickReport} />
//               <UploadLoadset />
//             </section>
//           </div>
