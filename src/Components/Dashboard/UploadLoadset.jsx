  ...
  return (
    ...
    >
      ...
      <h3 className="text-[16px] font-semibold text-[#265768] text-center">
        Quick Actions <span className="text-[15px]">⚡</span>
      </h3>
      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-3">
        <button
          ...
          className="w-[230px] h-[40px] text-[13px] font-medium text-[#4B8FA8] bg-white border border-[#B4D4DF] rounded-[10px] shadow-[0px_4px_20px_rgba(148,163,184,0.15)] hover:bg-[#F4FBFF] transition-colors"
        >
          Generate Timetable
        </button>
