...
//         <div className="pt-4">
//           <Button onClick={onNext} className=" bg-gradient-to-r from-teal-600 to-teal-500 hover:from-teal-700 hover:to-teal-600 text-white font-medium py-3 px-6 rounded-md shadow-md transition-all duration-200">
//             Connect ERP
//           </Button>
//         </div>
//       </div>
